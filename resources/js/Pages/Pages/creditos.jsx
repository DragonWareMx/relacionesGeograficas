                ...
                <Grid container justifyContent="space-between">
                    <Grid item xs={12} sm={6} className="pd-ri-50">
                        ...
                        <p>
                            ...
                            <br />
                            Dirección de Patrimonio, Protección y Conservación
                        ...
                        <p>
                            ...
                            <br />
                            Jefe del Centro de Documentación e Investigación de
                            las Artes
                        </p>
                    </Grid>
                    <Grid item xs={12} sm={6} className="pd-le-50">
                        ...
                        <p>
                            ...
                            <br />
                            Departamento de Conservación y Restauración de Obras
                            de Arte
                            <br />
                            –SECUM–
                            <br />
                            Departamento Editorial de la Universidad Autónoma de
                            Aguascalientes
                            <br />
                            Escuela Normal Urbana Federal “Profr. J. Jesús
                            Romero Flores” Fundación Cultural Alfredo Zalce
                            <br />
                            Museo Agrarista de Michoacán, Tzurumutaro, Michoacán
                            Museo de Arte Contemporáneo Alfredo Zalce
                            <br />
                            Museo Nacional de Antropología e Historia Periódico
                            La Voz de Michoacán
                            <br />
                            Poder Judicial del Estado de Michoacán Presidencia
                            Municipal de Opopeo, Michoacán
                            <br />
                            Presidencia Municipal de Santa Ana Maya, Michoacán
                            Universidad Michoacana de San Nicolás de Hidalgo
                        </p>
                        <p>
                            Agustín Cárdenas Castro Alfredo Arreguín Mendoza
                            Azucena Solórzano Ávila Eduardo León López Familia
                            Escalera Coria Familia Torres Canals Felipe
                            Castañeda Jaramillo
                            <br />
                            Felipe Cuauhtémoc Castañeda Vargas Francisco García
                            de la Torre
                            <br />
                            Francisco Rodríguez Oñate Gerónimo Mateo Madrigal
                            Juan García Chávez
                            <br />
