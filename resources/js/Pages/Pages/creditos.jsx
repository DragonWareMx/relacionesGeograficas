            ...
            <Grid container  justifyContent="space-between">
                <Grid item xs={12} sm={6} className="pd-ri-50">
                    ...
                    <p>
                        ...
                        <br />
                        Dirección de Producción Artística y Desarrollo Cultural
                        </p>
                    <p>
                        Marco Antonio Villegas García
                        <br />
                        Dirección de Patrimonio, Protección y Conservación de Monumentos y Sitios Históricos
                        </p>
                    <p>
                ...
                <Grid item xs={12} sm={6} className="pd-le-50">
                    ...
                    <p>
                         Agustín Cárdenas Castro Alfredo Arreguín Mendoza Azucena Solórzano Ávila Eduardo León López Familia Escalera Coria Familia Torres Canals Felipe Castañeda Jaramillo<br />
                        Felipe Cuauhtémoc Castañeda Vargas Francisco García de la Torre<br />
                        Francisco Rodríguez Oñate Gerónimo Mateo Madrigal Juan García Chávez<br />
                        Luis Palomares Frías<br />
                        Marco Antonio López Prado<br />
                        Mar a Auxilio Cárdenas Rodríguez Martha Esparza Ramírez<br />
                        Martin A. Foley Greenan Martín Feliciano Béjar<br />
                    </p>
                </Grid>
            </Grid>
        </Container>
...
Creditos.layout = page => <Layout children={page} title="Créditos" pageTitle="Créditos" />
